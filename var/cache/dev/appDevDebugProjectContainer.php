...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony-fosuserbundle', 'user' => 'root', 'password' => 'bo123456', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Trascastro/UserBundle/Entity'))), 'Trascastro\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('UserBundle' => 'Trascastro\\UserBundle\\Entity'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'app_name' => 'Symfony Classroom',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_name' => 'symfony-fosuserbundle',
            'database_user' => 'root',
