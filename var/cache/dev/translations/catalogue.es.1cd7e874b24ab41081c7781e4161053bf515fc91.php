...
$catalogue = new MessageCatalogue('es', array (
  ...
  'messages' => 
  array (
    'app.translator.test1.msg2' => 'Hola %name%',
    'app.translator.test1.msg1' => 'Hola %name%',
    'app.translator.test1.msg3' => 'Hola %name%',
    'app.translator.index.msg2' => 'Hola mensaje 2',
    'app.translator.index.msg1' => 'Hola mensaje 1',
    'app.translator.index.msg3' => 'Hola mensaje 3',
    'app.translator.test2.msg3' => '{0}No hay manzanas|{1}Hay una manzana|]1,Inf[Hay muchas manzanas',
    'app.translator.test2.msg2' => '{0}No hay manzanas para %name%|{1}Hay una manzana para %name%|]1,Inf[Hay muchas manzanas para %name%',
    'app.translator.test2.msg1' => '{0}No hay manzanas|{1}Hay una manzana|]1,Inf[Hay muchas manzanas',
  ),
));
