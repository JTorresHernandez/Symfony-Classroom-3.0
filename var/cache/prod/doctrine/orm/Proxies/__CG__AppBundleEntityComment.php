...
class Comment extends \AppBundle\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'author', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'article', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Comment' . "\0" . 'updatedAt');
        }
